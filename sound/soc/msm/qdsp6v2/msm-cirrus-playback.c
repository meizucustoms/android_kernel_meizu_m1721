...
void *crus_gen_afe_set_header(int length, int port, int module,
				     int param)
{
...
void *crus_gen_afe_get_header(int length, int port, int module,
				     int param)
{
...
int crus_afe_send_config(const char *data, int32_t length,
