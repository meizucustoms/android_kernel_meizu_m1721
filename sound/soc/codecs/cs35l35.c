 ...
 * Copyright 2020 MeizuCustoms team
 *
...
static int cs35l35_main_amp_event(struct snd_soc_dapm_widget *w,
  ...
  case SND_SOC_DAPM_PRE_PMU:
    if (cs35l35->pdata.bst_pdn_fet_on)
      regmap_update_bits(cs35l35->regmap, CS35L35_PWRCTL2, CS35L35_PDN_BST_MASK,
  ...
  case SND_SOC_DAPM_POST_PMU:
    ...
    if (cs35l35->pdm_mode)
      regmap_update_bits(cs35l35->regmap, CS35L35_BST_CVTR_V_CTL,
                         CS35L35_BST_CTL_MASK, 0 << CS35L35_BST_CTL_SHIFT);

    regmap_update_bits(cs35l35->regmap, CS35L35_PROTECT_CTL,
                       CS35L35_AMP_MUTE_MASK, 0);

    for (i = 0; i < 2; i++)
      regmap_bulk_read(cs35l35->regmap, CS35L35_INT_STATUS_1, &reg,
                       ARRAY_SIZE(reg));
...
static int cs35l35_wait_for_pdn(struct cs35l35_private *cs35l35) {
  ...
  ret = wait_for_completion_timeout(&cs35l35->pdn_done, msecs_to_jiffies(100));
  if (ret == 0) {
    dev_err(cs35l35->codec->dev, "PDN_DONE did not complete\n");
    return -ETIMEDOUT;
  }
...
static int cs35l35_sdin_event(struct snd_soc_dapm_widget *w,
  ...
  switch (event) {
  case SND_SOC_DAPM_PRE_PMU:
    regmap_update_bits(cs35l35->regmap, CS35L35_CLK_CTL1, CS35L35_MCLK_DIS_MASK,
                       0 << CS35L35_MCLK_DIS_SHIFT);
    regmap_update_bits(cs35l35->regmap, CS35L35_PWRCTL1,
                       CS35L35_DISCHG_FILT_MASK,
                       0 << CS35L35_DISCHG_FILT_SHIFT);
    regmap_update_bits(cs35l35->regmap, CS35L35_PWRCTL1, CS35L35_PDN_ALL_MASK,
                       0);
    break;
  case SND_SOC_DAPM_POST_PMD:
    regmap_update_bits(cs35l35->regmap, CS35L35_PWRCTL1,
    ...
    regmap_update_bits(cs35l35->regmap, CS35L35_AMP_DIG_VOL_CTL,
                       CS35L35_AMP_DIGSFT_MASK, 1 << CS35L35_AMP_DIGSFT_SHIFT);
    break;
  default:
    dev_err(codec->dev, "Invalid event = 0x%x\n", event);
    ret = -EINVAL;
...
static const struct snd_kcontrol_new cs35l35_aud_controls[] = {
    SOC_SINGLE_SX_TLV("Digital Audio Volume", CS35L35_AMP_DIG_VOL, 0, 0x34,
                      0xE4, dig_vol_tlv),
...
static const struct snd_kcontrol_new cs35l35_adv_controls[] = {
    SOC_SINGLE_SX_TLV("Digital Advisory Volume", CS35L35_ADV_DIG_VOL, 0, 0x34,
                      0xE4, dig_vol_tlv),
...
static SOC_ENUM_SINGLE_DECL(clksel_enum, SND_SOC_NOPM, 0, cs35l35_clksel_text);
...
static SOC_ENUM_SINGLE_DECL(pdm_en_enum, SND_SOC_NOPM, 0, cs35l35_pdm_en_text);
...
static struct snd_soc_dapm_route cs35l35_audio_map[] = {
    {"IMON ADC", NULL, "ISENSE"},   {"VMON ADC", NULL, "VSENSE"},
    {"SDOUT", NULL, "IMON ADC"},    {"SDOUT", NULL, "VMON ADC"},
    {"SDIN", NULL, "AMP Playback"}, {"CLASS H", NULL, "SDIN"},
    {"Main AMP", NULL, "CLASS H"},  {"VMON ADC", NULL, "Main AMP"},
    {"IMON ADC", NULL, "Main AMP"}, {"SPK", NULL, "SDOUT"},
...
static int cs35l35_set_dai_fmt(struct snd_soc_dai *codec_dai,
  ...
  case SND_SOC_DAIFMT_CBM_CFM:
    regmap_update_bits(cs35l35->regmap, CS35L35_CLK_CTL1, CS35L35_MS_MASK,
                       1 << CS35L35_MS_SHIFT);
...
static struct cs35l35_sysclk_config cs35l35_clk_ctl[] = {
    ...
    {5644800, 44100, 0x00},   {5644800, 88200, 0x40},  {6144000, 48000, 0x10},
    {6144000, 96000, 0x50},   {11289600, 44100, 0x01}, {11289600, 88200, 0x41},
    {11289600, 176400, 0x81}, {12000000, 44100, 0x03}, {12000000, 48000, 0x13},
    {12000000, 88200, 0x43},  {12000000, 96000, 0x53}, {12000000, 176400, 0x83},
    {12000000, 192000, 0x93}, {12288000, 48000, 0x11}, {12288000, 96000, 0x51},
    {12288000, 192000, 0x91}, {13000000, 44100, 0x07}, {13000000, 48000, 0x17},
    {13000000, 88200, 0x47},  {13000000, 96000, 0x57}, {13000000, 176400, 0x87},
    {13000000, 192000, 0x97}, {22579200, 44100, 0x02}, {22579200, 88200, 0x42},
    {22579200, 176400, 0x82}, {24000000, 44100, 0x0B}, {24000000, 48000, 0x1B},
    {24000000, 88200, 0x4B},  {24000000, 96000, 0x5B}, {24000000, 176400, 0x8B},
    {24000000, 192000, 0x9B}, {24576000, 48000, 0x12}, {24576000, 96000, 0x52},
    {24576000, 192000, 0x92}, {26000000, 44100, 0x0F}, {26000000, 48000, 0x1F},
    {26000000, 88200, 0x4F},  {26000000, 96000, 0x5F}, {26000000, 176400, 0x8F},
...
static int cs35l35_hw_params(struct snd_pcm_substream *substream,
  ...
  printk("cs35l35_codec_set_sysclk: clk_id = %d, freq = %d, clksrc = %d\n",
  ...
  if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK) {
    ...
    regmap_update_bits(cs35l35->regmap, CS35L35_AUDIN_DEPTH_CTL,
  ...
  if (cs35l35->i2s_mode) {
    ...
    ret = regmap_update_bits(cs35l35->regmap, CS35L35_CLK_CTL3,
...
static const unsigned int cs35l35_src_rates[] = {44100, 48000,  88200,
                                                 96000, 176400, 192000};
...
static const unsigned int cs35l35_pdm_rates[] = {44100, 48000, 88200, 96000};
...
static int cs35l35_dai_set_sysclk(struct snd_soc_dai *dai, int clk_id,
...
static int cs35l35_codec_set_sysclk(struct snd_soc_codec *codec, int clk_id,
...
static int cs35l35_codec_probe(struct snd_soc_codec *codec) {
  ...
  if (cs35l35->pdata.bst_ipk)
    regmap_update_bits(cs35l35->regmap, CS35L35_BST_PEAK_I,
                       CS35L35_CH_VP_MAN_MASK, cs35l35->pdata.bst_ipk);
  ...
  if (cs35l35->pdata.aud_channel)
    regmap_update_bits(cs35l35->regmap, CS35L35_AUDIN_RXLOC_CTL,
                       CS35L35_AUD_IN_LR_MASK,
                       cs35l35->pdata.aud_channel << CS35L35_AUD_IN_LR_SHIFT);

  if (cs35l35->pdata.stereo) {
    regmap_update_bits(cs35l35->regmap, CS35L35_ADVIN_RXLOC_CTL,
  ...
  if (cs35l35->pdata.sp_drv_str)
    regmap_update_bits(cs35l35->regmap, CS35L35_CLK_CTL1, CS35L35_SP_DRV_MASK,
                       cs35l35->pdata.sp_drv_str << CS35L35_SP_DRV_SHIFT);

  if (classh->classh_algo_enable) {
    if (classh->classh_bst_override)
      regmap_update_bits(
          cs35l35->regmap, CS35L35_CLASS_H_CTL, CS35L35_CH_BST_OVR_MASK,
          classh->classh_bst_override << CS35L35_CH_BST_OVR_SHIFT);
    if (classh->classh_bst_max_limit)
      regmap_update_bits(
          cs35l35->regmap, CS35L35_CLASS_H_CTL, CS35L35_CH_BST_LIM_MASK,
          classh->classh_bst_max_limit << CS35L35_CH_BST_LIM_SHIFT);
    if (classh->classh_mem_depth)
      regmap_update_bits(
          cs35l35->regmap, CS35L35_CLASS_H_CTL, CS35L35_CH_MEM_DEPTH_MASK,
  ...
  if (monitor_config->is_present) {
    if (monitor_config->vmon_specs) {
      ...
      regmap_update_bits(cs35l35->regmap, CS35L35_VMON_TXLOC_CTL,
    ...
    if (monitor_config->imon_specs) {
      ...
      regmap_update_bits(cs35l35->regmap, CS35L35_IMON_TXLOC_CTL,
                         CS35L35_MON_TXLOC_MASK,
    ...
    if (monitor_config->vpmon_specs) {
      regmap_update_bits(
          cs35l35->regmap, CS35L35_SUPMON_DEPTH_CTL, CS35L35_VPMON_DEPTH_MASK,
          monitor_config->vpmon_dpth << CS35L35_VPMON_DEPTH_SHIFT);
      regmap_update_bits(cs35l35->regmap, CS35L35_VPMON_TXLOC_CTL,
                         CS35L35_MON_TXLOC_MASK,
    ...
    if (monitor_config->vbstmon_specs) {
      regmap_update_bits(
          cs35l35->regmap, CS35L35_SUPMON_DEPTH_CTL, CS35L35_VBSTMON_DEPTH_MASK,
      ...
      regmap_update_bits(cs35l35->regmap, CS35L35_VBSTMON_TXLOC_CTL,
                         CS35L35_MON_FRM_MASK,
    ...
    if (monitor_config->vpbrstat_specs) {
      ...
      regmap_update_bits(cs35l35->regmap, CS35L35_VPBR_STATUS_TXLOC_CTL,
                         CS35L35_MON_TXLOC_MASK,
    ...
    if (monitor_config->zerofill_specs) {
      ...
      regmap_update_bits(
          cs35l35->regmap, CS35L35_ZERO_FILL_LOC_CTL, CS35L35_MON_TXLOC_MASK,
          monitor_config->zerofill_loc << CS35L35_MON_TXLOC_SHIFT);
      regmap_update_bits(cs35l35->regmap, CS35L35_ZERO_FILL_LOC_CTL,
                         CS35L35_MON_FRM_MASK,
...
static irqreturn_t cs35l35_irq(int irq, void *data) {
  ...
  pr_info_ratelimited("cs35l35_irq: [handler] irq: %d, gpio: %d\n",
                      cs35l35->irq, desc_to_gpio(cs35l35->irq_gpio));
  ...
  if (sticky1 & CS35L35_CAL_ERR) {
    ...
    if (!(current1 & CS35L35_CAL_ERR)) {
      ...
      regmap_update_bits(cs35l35->regmap, CS35L35_PROT_RELEASE_CTL,
                         CS35L35_CAL_ERR_RLS, CS35L35_CAL_ERR_RLS);
      regmap_update_bits(cs35l35->regmap, CS35L35_PROT_RELEASE_CTL,
                         CS35L35_CAL_ERR_RLS, 0);
    }
  }
  ...
  if (sticky1 & CS35L35_AMP_SHORT) {
    ...
    if (!(current1 & CS35L35_AMP_SHORT)) {
      ...
      regmap_update_bits(cs35l35->regmap, CS35L35_PROT_RELEASE_CTL,
                         CS35L35_SHORT_RLS, 0);
      regmap_update_bits(cs35l35->regmap, CS35L35_PROT_RELEASE_CTL,
                         CS35L35_SHORT_RLS, CS35L35_SHORT_RLS);
      regmap_update_bits(cs35l35->regmap, CS35L35_PROT_RELEASE_CTL,
                         CS35L35_SHORT_RLS, 0);
    }
  }
  ...
  if (sticky1 & CS35L35_OTW) {
    ...
    if (!(current1 & CS35L35_OTW)) {
      ...
      regmap_update_bits(cs35l35->regmap, CS35L35_PROT_RELEASE_CTL,
                         CS35L35_OTW_RLS, 0);
      regmap_update_bits(cs35l35->regmap, CS35L35_PROT_RELEASE_CTL,
                         CS35L35_OTW_RLS, CS35L35_OTW_RLS);
      regmap_update_bits(cs35l35->regmap, CS35L35_PROT_RELEASE_CTL,
                         CS35L35_OTW_RLS, 0);
    }
  }
  ...
  if (sticky3 & CS35L35_BST_HIGH) {
    ...
    regmap_update_bits(cs35l35->regmap, CS35L35_PWRCTL2, CS35L35_PDN_AMP,
                       CS35L35_PDN_AMP);
    regmap_update_bits(cs35l35->regmap, CS35L35_PWRCTL1, CS35L35_PDN_ALL,
                       CS35L35_PDN_ALL);
  }
...
static int cs35l35_handle_of_data(struct i2c_client *i2c_client,
  ...
  if (of_property_read_u32(np, "cirrus,boost-peak-milliamp", &val32) >= 0) {
    if (2800 < val32 - 1680) {
      ...
      dev_err(&i2c_client->dev, "Invalid Boost Peak Amp %d mA\n", val32);
    }
  }
  ...
  if (pdata->stereo) {
    ...
    if (of_property_read_u32(np, "cirrus,advisory-channel", &val32) >= 0)
      pdata->adv_channel = val32;
    pdata->shared_bst = of_property_read_bool(np, "cirrus,shared-boost");
  }
  ...
  if (classh_config->classh_algo_enable) {
    ...
    if (of_property_read_u32(classh, "cirrus,classh-bst-max-limit", &val32) >=
        0)
      classh_config->classh_bst_max_limit = val32;
    if (of_property_read_u32(classh, "cirrus,classh-mem-depth", &val32) >= 0)
      classh_config->classh_mem_depth = val32;
    if (of_property_read_u32(classh, "cirrus,classh-release-rate", &val32) >= 0)
      classh_config->classh_release_rate = val32;
    if (of_property_read_u32(classh, "cirrus,classh-headroom", &val32) >= 0)
      classh_config->classh_headroom = val32;
    if (of_property_read_u32(classh, "cirrus,classh-wk-fet-disable", &val32) >=
        0)
      classh_config->classh_wk_fet_disable = val32;
    if (of_property_read_u32(classh, "cirrus,classh-wk-fet-delay", &val32) >= 0)
      classh_config->classh_wk_fet_delay = val32;
    if (of_property_read_u32(classh, "cirrus,classh-wk-fet-thld", &val32) >= 0)
      classh_config->classh_wk_fet_thld = val32;
    if (of_property_read_u32(classh, "cirrus,classh-vpch-auto", &val32) >= 0)
      classh_config->classh_vpch_auto = val32;
    if (of_property_read_u32(classh, "cirrus,classh-vpch-rate", &val32) >= 0)
      classh_config->classh_vpch_rate = val32;
    if (of_property_read_u32(classh, "cirrus,classh-vpch-man", &val32) >= 0)
  ...
  if (monitor_config->is_present) {
    ret = of_property_read_u8_array(signal_format, "cirrus,imon", monitor_array,
                                    ARRAY_SIZE(monitor_array));
    if (!ret) {
    ...
    ret = of_property_read_u8_array(signal_format, "cirrus,vmon", monitor_array,
                                    ARRAY_SIZE(monitor_array));
    if (!ret) {
...
static const struct reg_default cs35l35_errata_patch[] = {
    {0x7F, 0x99}, {0x00, 0x99}, {0x52, 0x22}, {0x04, 0x14},
    {0x6D, 0x44}, {0x24, 0x10}, {0x58, 0xC4}, {0x00, 0x98},
    {0x18, 0x08}, {0x00, 0x00}, {0x7F, 0x00},
};

static int cs35l35_i2c_probe(struct i2c_client *i2c_client,
                             const struct i2c_device_id *id) {
  struct cs35l35_private *cs35l35;
  struct cs35l35_platform_data *pdata = dev_get_platdata(&i2c_client->dev);
  struct device_node *np = i2c_client->dev.of_node;
  ...
  cs35l35 = devm_kzalloc(&i2c_client->dev, sizeof(struct cs35l35_private),
                         GFP_KERNEL);
  if (!cs35l35) {
  ...
  ret = devm_regulator_bulk_get(&i2c_client->dev, cs35l35->num_supplies,
                                cs35l35->supplies);
  if (ret != 0) {
  ...
  pdata = devm_kzalloc(&i2c_client->dev, sizeof(struct cs35l35_platform_data),
                       GFP_KERNEL);
  if (!pdata) {
  ...
  ret = regulator_bulk_enable(cs35l35->num_supplies, cs35l35->supplies);
  if (ret) {
  ...
  if (!p) {
    dev_err(dev, "Failed to get cs35l35 pinctrl\n");
    return -EFAULT;
  }

  ret = pinctrl_select_state(p, pinctrl_lookup_state(p, "cs35l35_irq"));
  if (ret) {
  ...
  if (!gpio_is_valid(cs35l35->reset_gpio)) {
  ...
  // Set debounce
  ret = of_property_read_u32(np, "cirrus,debounce-interval", &debounce);
  if (ret < 0) {
    dev_err(dev, "%s: failed to get debounce interval: %d\n", __func__, ret);
    return ret;
  }

  irq_gpio = of_get_named_gpio_flags(i2c_client->dev.of_node, "irq-gpio", 0, 0);
  if (!irq_gpio || !gpio_is_valid(irq_gpio)) {
    dev_err(dev, "%s: invalid IRQ GPIO: %d\n", __func__, irq_gpio);
    return -EFAULT;
  }

  dev_info(dev, "%s: debounce interval: %d", __func__, debounce);

  ret = gpiod_set_debounce(gpio_to_desc(irq_gpio), debounce);
  if (ret) {
    dev_err(dev, "%s: failed to set debounce for gpio %d: %d\n", __func__,
            irq_gpio, ret);
  }
  ...
  cs35l35->irq_gpio =
      devm_gpiod_get_optional(&i2c_client->dev, "irq", GPIOD_IN);
  if (IS_ERR(cs35l35->irq_gpio)) {
    dev_err(dev, "Failed to get irq GPIO: %d", PTR_ERR(cs35l35->irq_gpio));
    return PTR_ERR(cs35l35->irq_gpio);
  }

  cs35l35->irq = irq_of_parse_and_map(np, 0);
  ...
  regmap_update_bits(cs35l35->regmap, CS35L35_PWRCTL2, CS35L35_PWR2_PDN_MASK,
  ...
  regmap_update_bits(cs35l35->regmap, CS35L35_PWRCTL3, CS35L35_PWR3_PDN_MASK,
                     CS35L35_PWR3_PDN_MASK);

  regmap_update_bits(cs35l35->regmap, CS35L35_PROTECT_CTL,
                     CS35L35_AMP_MUTE_MASK, 1 << CS35L35_AMP_MUTE_SHIFT);

  ret = snd_soc_register_codec(&i2c_client->dev, &soc_codec_dev_cs35l35,
  ...
  ret = devm_request_threaded_irq(dev, cs35l35->irq, NULL, cs35l35_irq,
                                  IRQF_ONESHOT | IRQF_TRIGGER_LOW, "cs35l35",
                                  cs35l35);
  if (ret != 0) {
...
static const struct i2c_device_id cs35l35_id[] = {{"cs35l35", 0}, {}};
