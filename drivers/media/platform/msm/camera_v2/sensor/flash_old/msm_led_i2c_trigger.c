...
void msm_led_i2c_torch_brightness_set(struct led_classdev *led_cdev,
...
struct led_classdev msm_torch_i2c_led = {
    .name = "torch-light0",
...
int msm_flash_i2c_probe(struct i2c_client *client,
  ...
  sprintf(fctrl->msm_sd.sd.name, "%s", id->name);
